#!/usr/bin/env python3
"""
Fine-tune Stable Diffusion for colorization on your synthetic pairs.
"""
...
class ColorizationDataset(Dataset):
    """Dataset for colorization: grayscale input -> color output."""
...
def train_colorization(
    ...
    # Log start
    logger.info("="*60)
    logger.info("Fine-tuning Stable Diffusion for Colorization")
    logger.info("="*60)
    logger.info(f"Training started at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    
    print("="*60)
    print("Fine-tuning Stable Diffusion for Colorization")
    print("="*60)
    ...
    train_dataset_temp = ColorizationDataset(train_input_dir, train_gt_dir, image_size=image_size)
    num_train_steps = max(
        1,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fine-tune Stable Diffusion for colorization")
    parser.add_argument("--train_input", type=str, default="data/pairs/colorize/train/input",
                       help="Training input directory (grayscale images)")
    parser.add_argument("--train_gt", type=str, default="data/pairs/colorize/train/gt",
                       help="Training ground truth directory (color images)")
    parser.add_argument("--val_input", type=str, default="data/pairs/colorize/val/input",
                       help="Validation input directory")
    parser.add_argument("--val_gt", type=str, default="data/pairs/colorize/val/gt",
                       help="Validation ground truth directory")
    parser.add_argument("--output_dir", type=str, default="outputs/models/colorization",
    ...
    parser.add_argument("--base_model", type=str, default="runwayml/stable-diffusion-v1-5",
                       help="Base model to fine-tune from. Options: "
                            ...
                            "'stabilityai/stable-diffusion-2-1' (better prompt following, may require HF token).")
